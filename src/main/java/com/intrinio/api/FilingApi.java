...
public class FilingApi {
     ...
     */
    public com.squareup.okhttp.Call getAllFilingsCall(String company, String reportType, LocalDate startDate, LocalDate endDate, String industryCategory, String industryGroup, Boolean earningsRelease, Integer pageSize, String nextPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getAllFilingsValidateBeforeCall(String company, String reportType, LocalDate startDate, LocalDate endDate, String industryCategory, String industryGroup, Boolean earningsRelease, Integer pageSize, String nextPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAllFilingsCall(company, reportType, startDate, endDate, industryCategory, industryGroup, earningsRelease, pageSize, nextPage, progressListener, progressRequestListener);
        return call;
     ...
     */
    public ApiResponseFilings getAllFilings(String company, String reportType, LocalDate startDate, LocalDate endDate, String industryCategory, String industryGroup, Boolean earningsRelease, Integer pageSize, String nextPage) throws ApiException, NoSuchMethodException {
      ...
      Object[] apiCallArguments = { company, reportType, startDate, endDate, industryCategory, industryGroup, earningsRelease, pageSize, nextPage };
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiResponseFilings> getAllFilingsWithHttpInfo(String company, String reportType, LocalDate startDate, LocalDate endDate, String industryCategory, String industryGroup, Boolean earningsRelease, Integer pageSize, String nextPage) throws ApiException {
        com.squareup.okhttp.Call call = getAllFilingsValidateBeforeCall(company, reportType, startDate, endDate, industryCategory, industryGroup, earningsRelease, pageSize, nextPage, null, null);
     ...
     */
    public com.squareup.okhttp.Call getAllFilingsAsync(String company, String reportType, LocalDate startDate, LocalDate endDate, String industryCategory, String industryGroup, Boolean earningsRelease, Integer pageSize, String nextPage, final ApiCallback<ApiResponseFilings> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAllFilingsValidateBeforeCall(company, reportType, startDate, endDate, industryCategory, industryGroup, earningsRelease, pageSize, nextPage, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiResponseFilings>(){}.getType();

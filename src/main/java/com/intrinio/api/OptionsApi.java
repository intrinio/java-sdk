...
public class OptionsApi {
     ...
     * @throws NoSuchMethodException If fail to get specified method off of the main class
     */
    public ApiResponseOptionPricesRealtime getOptionsPricesRealtime(String identifier, String source) throws ApiException, NoSuchMethodException {
      ...
      ApiResponse<ApiResponseOptionPricesRealtime> resp = apiClient.attemptApiCall(targetMethod, apiCallArguments);
      return resp.getData();
    }
     ...
     * @param identifier The Intrinio ID or code of the options contract to request prices for. (required)
     * @param source Realtime or 15-minute delayed contracts. (optional)
     * @return ApiResponse&lt;ApiResponseOptionPricesRealtime&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiResponseOptionPricesRealtime> getOptionsPricesRealtimeWithHttpInfo(String identifier, String source) throws ApiException {
        com.squareup.okhttp.Call call = getOptionsPricesRealtimeValidateBeforeCall(identifier, source, null, null);
        Type localVarReturnType = new TypeToken<ApiResponseOptionPricesRealtime>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getOptionsPricesRealtimeAsync(String identifier, String source, final ApiCallback<ApiResponseOptionPricesRealtime> callback) throws ApiException {

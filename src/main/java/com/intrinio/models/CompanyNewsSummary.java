...
public class CompanyNewsSummary {
  ...
  **/
  ...
  public CompanyNewsSummary body(String body) {
    this.body = body;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, companyNewsSummary.id) &&
        ...
        Objects.equals(this.body, companyNewsSummary.body);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, title, publicationDate, url, summary, source, topics, copyright, language, wordCount, spam, businessRelevance, articleSentiment, articleSentimentConfidence, body);
  }

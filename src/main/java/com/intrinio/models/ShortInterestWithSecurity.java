...
public class ShortInterestWithSecurity {
  ...
  public ShortInterestWithSecurity settlementDate(LocalDate settlementDate) {
  ...
  **/
  ...
  public ShortInterestWithSecurity currentShortPosition(Integer currentShortPosition) {
  ...
  **/
  ...
  public ShortInterestWithSecurity previousShortPosition(Integer previousShortPosition) {
  ...
  **/
  ...
  public ShortInterestWithSecurity changePercent(Float changePercent) {
  ...
  **/
  ...
  public ShortInterestWithSecurity daysToCover(Float daysToCover) {
  ...
  **/
  ...
  public ShortInterestWithSecurity averageDailyVolume(Integer averageDailyVolume) {
  ...
  **/
  ...
  public ShortInterestWithSecurity security(SecuritySummary security) {
   ...
   * @return security
  **/
  @ApiModelProperty(value = "The security associated with this short interest record")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ShortInterestWithSecurity shortInterestWithSecurity = (ShortInterestWithSecurity) o;
    return Objects.equals(this.settlementDate, shortInterestWithSecurity.settlementDate) &&
        Objects.equals(this.currentShortPosition, shortInterestWithSecurity.currentShortPosition) &&
        Objects.equals(this.previousShortPosition, shortInterestWithSecurity.previousShortPosition) &&
        Objects.equals(this.changePercent, shortInterestWithSecurity.changePercent) &&
        Objects.equals(this.daysToCover, shortInterestWithSecurity.daysToCover) &&
        Objects.equals(this.averageDailyVolume, shortInterestWithSecurity.averageDailyVolume) &&
        Objects.equals(this.security, shortInterestWithSecurity.security);
  }

  @Override
  public int hashCode() {
    return Objects.hash(settlementDate, currentShortPosition, previousShortPosition, changePercent, daysToCover, averageDailyVolume, security);
  }

...
**connectedOn** | [**OffsetDateTime**](OffsetDateTime.md) | The UTC time this client connection connected to the server. &nbsp;
**statusUpdatedOn** | [**OffsetDateTime**](OffsetDateTime.md) | The UTC time the server updated this client connection status data. &nbsp;
...
**packetsPerSecond** | [**BigDecimal**](BigDecimal.md) | The packets per second sent since the last status update. &nbsp;
...
**eventsPerSecond** | [**BigDecimal**](BigDecimal.md) | The events per second sent since the last status update. &nbsp;
...
**queueDepthPercentage** | [**BigDecimal**](BigDecimal.md) | The percentage that the connection&#39;s server-side queue is full. 0-100. &nbsp;

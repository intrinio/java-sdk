...
**expirationTime** | [**OffsetDateTime**](OffsetDateTime.md) | The date on which the Option expires. The Option becomes invalid after this date and cannot be exercised. &nbsp;

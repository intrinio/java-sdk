...
> ApiResponseOptionsChainEod getOptionsChainEod(symbol, expiration, type, strike, strikeGreaterThan, strikeLessThan)
...
> ApiResponseOptionsPricesBatchRealtime getOptionsPricesBatchRealtime(body, source)
